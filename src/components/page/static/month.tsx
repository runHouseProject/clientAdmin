...
// import CountUp from "react-countup"; // Ensure you have CountUp imported
// import CustomLabelPieChart from "./CustomLabelPieChart"; // Ensure you have these components
// import LineChartComponent from "./LineChartComponent"; // Ensure you have these components
// import { renderChangeRate } from "./helpers"; // Ensure you have this function
      ...
      <div className="p-1">
        <div className="flex space-x-4">
          ...
          <div className="flex flex-col flex-1 space-y-4">
            ...
            <div className="h-full space-x-4 flex-7">
              <div className="h-full p-5 border rounded-lg ">
                <div>17</div>
                <CustomLabelPieChart />
              </div>
